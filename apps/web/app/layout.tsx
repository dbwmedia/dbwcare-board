...
export const meta = () => [
  { title: "DBWCARE BOARD | Project Management by DBW Media" },
  ...
  { property: "og:title", content: "DBWCARE BOARD | Project Management by DBW Media" },
  {
    property: "og:description",
    content: "Open-source project management tool to manage work items, cycles, and product roadmaps easily",
  },
  { property: "og:url", content: "https://care.dbw-media.de/" },
  { property: "og:image", content: "https://care.dbw-media.de/og-image.png" },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "DBWCARE BOARD - Project Management" },
  { name: "twitter:site", content: "@dbwmedia" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://care.dbw-media.de/og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "DBWCARE BOARD - Project Management" },
];
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="DBWCARE BOARD" />
