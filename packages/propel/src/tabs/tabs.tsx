  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-[selected]:shadow-sm data-[selected]:raised-200 data-[selected]:border data-[selected]:border-subtle-1 data-[selected]:bg-layer-2 data-[selected]:text-primary data-[selected]:dbw-border-bottom-gradient",
