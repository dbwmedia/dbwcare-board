...
export default {
  ...
  dbwcare: {
    ...
    stop_timer_description: "Add a description for this time entry.",
    ...
    gift_reason_placeholder: "Why is this a gift?",
    save_error: "Error saving entry",
    stop_error: "Error stopping timer",
    base_quota: "Base quota",
    rolled_over: "Carried over",
    total_available: "Total available",
    consumed: "Used",
    remaining: "Remaining",
    remaining_this_month: "{time} remaining",
    borrowed_this_month: "{time} borrowed ahead",
    of_total: "of {time} this month",
    ...
    recurrence_monthly: "Monthly on day",
    recurrence_interval: "Every N days",
    estimated_duration: "Estimated duration",
    next_occurrence: "Next occurrence",
    pause_recurrence: "Pause recurrence",
    managed_by_team: "This setting is managed by your dbw team.",
    quick_select: "Quick select",
    save_success: "Settings saved successfully",
    mission_control: "DBWCARE Mission Control",
    mission_control_desc: "Overview of all projects with active care subscriptions.",
    no_active_subscriptions: "No active care subscriptions found.",
    project: "Project",
    utilization: "Utilization",
    balance_history: "Balance history (12 months)",
    month: "Month",
    no_subscription_yet: "No subscription yet",
    activate: "Activate",
    no_projects: "No projects found in this workspace.",
    provision_customer: "Create customer account",
    provision_title: "Create customer account",
    provision_first_name: "First name",
    provision_last_name: "Last name",
    provision_email: "E-mail",
    provision_password: "Password",
    provision_regenerate: "Generate new password",
    provision_manual_password: "Set password manually",
    provision_create: "Create account",
    provision_success: "Customer account created",
    provision_can_login: "can now log in.",
    provision_credentials_warning: "These credentials will not be shown again after closing.",
    provision_copy_all: "Copy all",
    provision_done: "Done",
    report_settings: "Monthly Report & Customer Data",
    report_settings_desc: "Configure the automatic monthly report sent on the 2nd of each month via email.",
    customer_name: "Customer name",
    customer_name_placeholder: "e.g. Acme Corp",
    customer_email: "Customer email",
    report_enabled: "Send monthly report automatically",
    report_no_email_warning: "No email recipient configured – the report cannot be sent.",
    send_report_now: "Report senden",
    report_current_month: "Aktueller Monat",
    report_sent_success: "Monthly report sent",
    report_sent_error: "Error sending monthly report",
  },
} as const;
