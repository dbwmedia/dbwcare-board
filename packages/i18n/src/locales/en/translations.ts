...
export default {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Welcome to DBWCARE BOARD, we are excited to have you here. Create your first project and track your work items, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primary_button: {
  ...
  // DBWCARE Time Tracking
  "dbwcare.time_tracking": "Time Tracking",
  "dbwcare.total": "Total",
  "dbwcare.manual_add": "Add manually",
  "dbwcare.start_timer": "Start timer",
  "dbwcare.stop_timer": "Stop timer",
  "dbwcare.stop_timer_description": "Add a description for this time entry.",
  "dbwcare.stop_and_save": "Stop & Save",
  "dbwcare.description": "Description",
  "dbwcare.description_placeholder": "What did you work on?",
  "dbwcare.description_min_length": "Description must be at least 3 characters",
  "dbwcare.duration": "Duration",
  "dbwcare.duration_required": "Duration must be greater than 0",
  "dbwcare.billing_status": "Billing",
  "dbwcare.billable": "Billable",
  "dbwcare.gift": "Gift",
  "dbwcare.gift_reason": "Gift reason",
  "dbwcare.gift_reason_placeholder": "Why is this a gift?",
  "dbwcare.save_error": "Error saving entry",
  "dbwcare.stop_error": "Error stopping timer",
  "dbwcare.base_quota": "Base quota",
  "dbwcare.rolled_over": "Carried over",
  "dbwcare.total_available": "Total available",
  "dbwcare.consumed": "Used",
  "dbwcare.remaining": "Remaining",
  "dbwcare.remaining_this_month": "{{time}} remaining",
  "dbwcare.borrowed_this_month": "{{time}} borrowed ahead",
  "dbwcare.of_total": "of {{time}} this month",
  "dbwcare.care_settings": "DBWCARE",
  "dbwcare.monthly_hours": "Monthly hours",
  "dbwcare.package_label": "Package label",
  "dbwcare.contract_start": "Contract start",
  "dbwcare.subscription_active": "Active",
  "dbwcare.care_status": "Care Status",
  "dbwcare.recurrence": "Recurring task",
  "dbwcare.recurrence_monthly": "Monthly on day",
  "dbwcare.recurrence_interval": "Every N days",
  "dbwcare.estimated_duration": "Estimated duration",
  "dbwcare.next_occurrence": "Next occurrence",
  ...
  "dbwcare.provision_customer": "Create customer account",
  "dbwcare.provision_title": "Create customer account",
  "dbwcare.provision_first_name": "First name",
  "dbwcare.provision_last_name": "Last name",
  "dbwcare.provision_email": "E-mail",
  "dbwcare.provision_password": "Password",
  "dbwcare.provision_regenerate": "Generate new password",
  "dbwcare.provision_manual_password": "Set password manually",
  "dbwcare.provision_create": "Create account",
  "dbwcare.provision_success": "Customer account created",
  "dbwcare.provision_can_login": "can now log in.",
  "dbwcare.provision_credentials_warning": "These credentials will not be shown again after closing.",
  "dbwcare.provision_copy_all": "Copy all",
  "dbwcare.provision_done": "Done",
} as const;
