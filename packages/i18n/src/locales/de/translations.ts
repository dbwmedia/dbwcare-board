...
export default {
  ...
  role_details: {
    guest: {
      title: "Kunde",
      description: "Kann Aufgaben erstellen, kommentieren und den Projektstatus einsehen.",
    },
    member: {
      title: "Entwickler",
      description: "Kann Aufgaben bearbeiten, Zeiten erfassen und Projekte verwalten.",
    },
    admin: {
      title: "Administrator",
  ...
  dbwcare: {
    time_tracking: "Zeiterfassung",
    total: "Gesamt",
    manual_add: "Manuell erfassen",
    start_timer: "Timer starten",
    stop_timer: "Timer stoppen",
    stop_timer_description: "Beschreibe kurz, woran du gearbeitet hast.",
    stop_and_save: "Stoppen & Speichern",
    description: "Beschreibung",
    description_placeholder: "Woran hast du gearbeitet?",
    description_min_length: "Beschreibung muss mindestens 3 Zeichen lang sein",
    duration: "Dauer",
    duration_required: "Dauer muss größer als 0 sein",
    billing_status: "Abrechnung",
    billable: "Abrechenbar",
    gift: "Geschenk des Hauses",
    ...
    consumed: "Bereits genutzt",
    remaining: "Noch übrig",
    remaining_this_month: "{time} übrig",
    borrowed_this_month: "Im Voraus genutzt: {time}",
    of_total: "von {time} diesen Monat",
    care_settings: "DBWCARE",
    monthly_hours: "Monatliche Stunden",
    package_label: "Paket-Bezeichnung",
    contract_start: "Vertragsbeginn",
    subscription_active: "Aktiv",
    care_status: "Care-Status",
    recurrence: "Wiederkehrende Aufgabe",
    recurrence_monthly: "Monatlich am",
    recurrence_interval: "Alle N Tage",
    estimated_duration: "Standard-Schätzung",
    next_occurrence: "Nächste Erzeugung",
    pause_recurrence: "Wiederholung pausieren",
    managed_by_team: "Diese Einstellung wird von deinem dbw-Team verwaltet.",
    quick_select: "Schnellauswahl",
    save_success: "Einstellungen erfolgreich gespeichert",
    mission_control: "DBWCARE Mission Control",
    mission_control_desc: "Überblick über alle Projekte mit aktiver Care-Subscription.",
    no_active_subscriptions: "Keine aktiven Care-Subscriptions gefunden.",
    project: "Projekt",
    utilization: "Auslastung",
    balance_history: "Verlauf (12 Monate)",
    month: "Monat",
    no_subscription_yet: "Noch keine Subscription",
    activate: "Aktivieren",
    no_projects: "Keine Projekte in diesem Workspace gefunden.",
    provision_customer: "Kunden-Account anlegen",
    provision_title: "Kunden-Account direkt anlegen",
    provision_first_name: "Vorname",
    provision_last_name: "Nachname",
    provision_email: "E-Mail",
    provision_password: "Passwort",
    provision_regenerate: "Neues Passwort generieren",
    provision_manual_password: "Passwort manuell ändern",
    provision_create: "Anlegen",
    provision_success: "Kunden-Account erstellt",
    provision_can_login: "kann sich jetzt einloggen.",
    provision_credentials_warning: "Diese Zugangsdaten werden nach dem Schließen nicht mehr angezeigt.",
    ...
    send_report_now: "Report jetzt senden",
